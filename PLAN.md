...
- 🟡 **Этап 1** — сделаны UI-kit (доски 04–07, 12, 13) и страница проекта: шапка с мини-шапкой, первый
  ...
  Тексты без англицизмов. Блок плана — заглушка (этап 3).
  **Осталось:** главная (фреймы «Главная»), страница `/projects`, юридические страницы (`/privacy`,
...
- ✅ Страница «Проект» (`23:2` / `27:254`) с попапами форм, лайтбоксом и баннером согласия; «Главная» — не начата.
