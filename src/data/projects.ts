...
export const projects: Project[] = [
  {
    ...
    review: {
      text: [
        ...
        { text: ' Фасады идеально совпали с образцом в выставочном зале. ' },
        { text: 'Клиент в восторге', strong: true },
        {
          text: ': кухня встала в нишу миллиметр в миллиметр, фурнитура работает мягко и бесшумно.\n\nОтдельное спасибо за сопровождение — специалист держал в курсе на каждом этапе, от замера до монтажа, а ',
        },
...
export type ProjectCardData = {
  ...
  /** Страница проекта; пока у проектов её нет — кнопка «Смотреть проект» без ссылки. */
  href?: string
}
...
export const projectCards: ProjectCardData[] = [
  {
    ...
    photo: {
      ...
      width: 1200,
      height: 1600,
      alt: 'Кухня Лофт 4.2 с барной стойкой',
    },
  },
  {
    title: 'Скандинавский белый — Гардеробная',
    meta: 'Кухня · 14 м² · 187 400 ₽',
    color: 'gray',
    photo: {
      ...
      width: 1209,
      height: 1145,
      alt: 'Светлая гардеробная Скандинавский белый',
    },
  },
  {
    title: 'Чёрный куб — Шкаф-купе',
    meta: 'Кухня · 14 м² · 187 400 ₽',
    color: 'stone',
    photo: {
